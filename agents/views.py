...
class AgentCreateView(OrganiserAndLoginRequiredMixin, generic.CreateView): #this is the agent create view that inherits from the create view class
    ...
    def form_valid(self, form):
        ...
        user.set_password(f"{user.username}123") #this is the default password for the user
        user.save()
        ...
        send_mail(
            ...
            message="You were added as an agent on HKCRM. Please come login to start working.",
